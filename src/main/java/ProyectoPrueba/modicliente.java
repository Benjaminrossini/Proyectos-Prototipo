...
public class modicliente extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
       Statement stmt;
        try {
            ...
            String sql = "UPDATE clientes SET nombre='" + this.jTextField1.getText() +
                          "' WHERE dni='"+ this.jComboBox1.getItemAt(jComboBox1.getSelectedIndex()).getDni()+ "'; ";
            stmt.execute(sql); 
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new modicliente().setVisible(true);
            }
        });
    }
