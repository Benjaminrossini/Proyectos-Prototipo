    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
       Statement instruccion = null;
        ...
        try {
            ...
            String sql = "SELECT * FROM clientes where dni ='" + jTextField1.getText() + "'";  
          ...
          while(conjuntoResultados.next()) { //0 registros, 1 registro
              ...
              ban1=1;
              this.jLabel2.setText( "Dni cliente " + conjuntoResultados.getObject(1));
              this.jLabel3.setText("Nombre Cliente " + conjuntoResultados.getObject(2));
          } // fin de while
            if(ban1==0) {
