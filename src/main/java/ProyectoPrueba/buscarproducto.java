...
public class buscarproducto extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("¿Que producto desea buscar?");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try {
            ...
            String sql = "SELECT * FROM producto where nombre ='" + jTextField1.getText() + "'";  
          ...
          while(conjuntoResultados.next()) { //0 registros, 1 registro
              ...
              ban1=1;
              this.jLabel2.setText( "ID Producto " + conjuntoResultados.getObject(1));
              this.jLabel3.setText("Nombre " + conjuntoResultados.getObject(2));
              this.jLabel4.setText("Cantidad " + conjuntoResultados.getObject(3));
              this.jLabel5.setText("Precio " + conjuntoResultados.getObject(7));
              this.jLabel6.setText("Tipo de Producto " + conjuntoResultados.getObject(5));
          } // fin de while
            if(ban1==0) {
