...
public class altaprev extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Alta Preventista");

        jLabel2.setText("Nombre Preventista");

        jButton1.setText("Guardar Preventista");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        String nombre = null;
        try{
            String sql = "select * from preventistas where nombre = '"+this.jTextField1.getText()+"'";
           ...
           if(nombre2.equals(nombre)){
               JOptionPane.showMessageDialog(null, "Preventista ya registrado");
           }else{
               String sql2 ="insert into preventistas " +
           "(nombre) " +
